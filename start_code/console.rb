...
star1=Star.new({'first_name' => 'Johnie', 'last_name'=>'Depp'})
star1.save()
...
movie3=Movie.new({'title'=> 'Bennie and Joon','genre'=>'comedy'})
movie3.save()

casting1=Casting.new({'movie_id'=> movie1.id,'star_id' => star1.id,'fee'=>'100000'})
casting1.save()

casting2=Casting.new({'movie_id'=> movie2.id,'star_id'=> star2.id, 'fee' =>'800000'})

casting2.save()

casting3=Casting.new({'movie_id'=>movie3.id,'star_id'=>star3.id,'fee'=>'900000'})
